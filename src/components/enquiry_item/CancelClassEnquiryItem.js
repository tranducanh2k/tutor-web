...
const CancelClassEnquiryItem = ({ classId, from, to, timestamp, content  }) => {
    ...
    return (
        <div className='enquiryItem'>
            <div className='leftSide'  onClick={(e) => handleContent(e)}>
                ...
                <div className='classId'>Id of cancel class: <span>{classId}</span></div>
                { openContent && 
...
export default CancelClassEnquiryItem